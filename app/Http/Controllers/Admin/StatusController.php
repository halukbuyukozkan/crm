...
class StatusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.status.index')->with('success', 'Durum başarıyla oluşturuldu.');
    }
    ...
    public function destroy(Status $status)
    {
        ...
        return redirect()->route('admin.status.index')->with('success', 'Durum Başarıyla Silindi');
    }
}
